...
-- Draai dit in de Supabase SQL-editor, of laat de app het zelf doen: de
-- Postgres-driver voert ditzelfde schema idempotent uit bij het eerste gebruik.
-- Bron van waarheid: lib/radio/store/schema.ts (RADIO_SCHEMA_SQL) — houd beide
-- in sync, net als bij 0001_geo_tables.sql.
